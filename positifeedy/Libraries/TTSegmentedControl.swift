...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var cornerRadiusOuter: CGFloat = -1 // for rounded corner radius use negative value, 0 to disable
    @IBInspectable open var cornerRadiusInner: CGFloat = -1 // for rounded corner radius use negative value, 0 to disable
    ...
    open override func layoutSubviews() {
        ...
        containerView.layer.cornerRadius = cornerRadiusOuter < 0 ? 0.5 * containerView.frame.size.height : cornerRadiusOuter
...
extension TTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbView.frame.size.height = containerView.frame.size.height - 6
        thumbView.layer.cornerRadius = cornerRadiusInner < 0 ? 0.5 * thumbView.frame.size.height : cornerRadiusInner
...
extension TTSegmentedControl {
    ...
    fileprivate func selectedViewWidthForPoint(_ point: CGPoint)-> CGFloat {
        ...
        let width = self.frame.width / CGFloat(self.itemTitles.count) //label.frame.size.width + padding.height
//        if index == 0 {
